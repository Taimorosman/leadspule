...
<br />
      ...
      <ol className="list-decimal pl-6 space-y-4 text-gray-800">
        <li>
          <strong>Unauthorized Access or Changes:</strong> <br />
          ...
          <ul className="list-disc pl-6 mt-2">
            ...
            <li>
              You agree to <strong>a 3-day suspension without pay</strong> and
              will be available to <strong>compensate for 3 days of salary</strong>.
            </li>
          </ul>
        </li>
